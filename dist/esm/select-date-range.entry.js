...
const renderWeekHeader = (weekDays = DEFAULT_WEEK_DAYS) => (h("header", null, weekDays.map(({ name, abbr, isWeekend }) => h("abbr", { class: isWeekend && DEFAULT_CLASSES.weekend, title: name }, abbr))));
const renderWeek = (week, renderHeader = false) => (h("section", { class: DEFAULT_CLASSES.week },
